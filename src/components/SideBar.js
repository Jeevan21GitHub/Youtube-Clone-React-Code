...
const SideBar = ({ selectedCategory, setSelectedCategory, setVideos }) => {
  ...
  return (
    <section className='bg-black fixed  mt-14 left-0 top-0 w-60 h-full md:h-[calc(100vh-53px)] scrollbar-thin scrollbar-thumb-gray-800 scrollbar-track-black overflow-y-scroll scrollbar-thumb-rounded-full scrollbar-track-rounded-full scrollbar-hide  hidden md:block z-10'>
      <Link to={`/`} >
        <div
