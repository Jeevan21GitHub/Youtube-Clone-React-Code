...
const NavBar = ({setSideBarHidden,setSelectedCategory}) => {
  ...
  return (
    <section className='bg-black text-white fixed w-full top-0 z-20 h-16 md:h-14'>
       <div className='container-fluid px-5'>
            <div className='flex flex-wrap items-center justify-between'>
                ...
                <div className='items-center hidden md:flex'>
                    ...
                    <input type='text' value={searchBox} className='rounded-l-3xl w-[550px] lg:w-[660px] bg-black border border-gray-800 px-2 py-1 h-8 focus:outline-none' placeholder='Search...' onChange={(e)=>setSearchBox(e.target.value)} />
                    </form>
                    ...
                    {/* <div className=' my-auto ml-3 bg-gray-900 p-2 rounded-fuzll cursor-pointer hover:bg-gray-800 hover:shadow-lg'>
                        <MdMic/>
                    </div> */}
                </div>
                <div className='items-center flex justify-center md:hidden '>
                    <form onSubmit={handleSearchBox} className=''>
                    <input type='text' value={searchBox} className='rounded-l-3xl w-44 bg-black border border-gray-800 px-2 py-1 h-8 focus:outline-none' placeholder='Search...' onChange={(e)=>setSearchBox(e.target.value)} />
                    </form>
                    <div className='my-auto p-2 border border-l-0 rounded-r-3xl  px-3 bg-gray-900 hover:bg-gray-800 cursor-pointer border-gray-800 h-8 '>
                    <HiMagnifyingGlass onClick={handleSearchBox} />
                    </div>
                ...
                <div className='flex justify-end items-center md:w-auto'>
                    ...
                    <div className='p-2'>
                        {
                            !user?(
                                <button className='bg-red-600 text-sm px-2 py-2 rounded-full hover:bg-red-700' onClick={handleLogin} ><GoSignIn/></button>
                            ):(
